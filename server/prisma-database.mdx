...
description: "Database schema for waste management, models, and Prisma ORM setup in Trash2Treasure"
---

## Overview

Trash2Treasure uses [Prisma](https://www.prisma.io/) as the ORM with PostgreSQL as the database.
...
Trash2Treasure uses a comprehensive Prisma schema with the following core models:
...
async function main() {
  ...
  await prisma.user.upsert({
    where: { email: "admin@trash2treasure.lk" },
    update: {},
    create: {
