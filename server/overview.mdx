...
description: "NestJS backend for handling waste pickups, sorting, and payments in Trash2Treasure"
---

## Introduction

The Trash2Treasure server is built with [NestJS](https://nestjs.com/), a progressive Node.js framework for building efficient and scalable server-side applications.
