...
description: "Required environment configuration for Trash2Treasure"
---

## Overview

Trash2Treasure requires environment variables for both server and client. Create `.env` files in the root directory for Docker Compose to use.
...
```bash
# Database (Required)
DATABASE_URL="postgresql://user:password@host:5432/trash2treasure?schema=public"
DIRECT_URL="postgresql://user:password@host:5432/trash2treasure"
...
```bash
DATABASE_URL="postgresql://user:password@prod-host:5432/trash2treasure?schema=public"
DIRECT_URL="postgresql://user:password@prod-host:5432/trash2treasure"
NODE_ENV=production
...
| -------------- | --------------------------------------------- | -------- | -------------------------------------------------------------------- |
| `DATABASE_URL` | PostgreSQL connection with schema             | ✅       | `postgresql://user:pass@localhost:5432/trash2treasure?schema=public` |
| `DIRECT_URL`   | PostgreSQL direct connection (for migrations) | ✅       | `postgresql://user:pass@localhost:5432/trash2treasure`               |
...
DATABASE_URL="postgresql://user:pass@prod-db:5432/trash2treasure"
JWT_SECRET="production-super-secure-secret-key"
NODE_ENV=production
CLIENT_URL="https://trash2treasure.lk"

# client/.env.production
NEXT_PUBLIC_API_URL="https://api.trash2treasure.lk/api"
````
