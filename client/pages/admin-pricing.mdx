---
title: "Admin Pricing"
description: "Pricing configuration for waste categories"
---
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Price/kg (LKR)</TableHead>
        ...
        <TableBody>
          {categories?.map((category) => (
            <TableRow key={category.id}>
              ...
              <TableCell>{category.minWeightKg} kg</TableCell>
              <TableCell>{category.maxWeightKg} kg</TableCell>
              <TableCell>
...
function CategoryModal({ category, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    minWeightKg: category?.minWeightKg ?? 1,
    maxWeightKg: category?.maxWeightKg ?? 100,
