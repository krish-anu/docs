...
description: "Booking management for drivers"
---
    ...
    <Card>
      ...
      <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
        <div>
          ...
          <p>{booking.estimatedWeightKg} kg</p>
        </div>
        <div>
      ...
      <div className="mt-4 flex gap-2">
        {booking.status === "ASSIGNED" && (
          <Button onClick={() => startMutation.mutate()}>Start Pickup</Button>
        )}
...
function CompletePickupModal({ booking, onClose }) {
  ...
  const finalAmount = actualWeight * booking.wasteCategory?.pricePerKg;
        ...
        <div className="space-y-4">
          ...
          <div className="bg-muted p-4 rounded-lg">
            ...
            <p className="text-xs text-muted">
              {actualWeight} kg × LKR {booking.wasteCategory?.pricePerKg}/kg
            </p>
          </div>
...
stateDiagram-v2
    ...
    ASSIGNED --> IN_PROGRESS: Driver starts
    IN_PROGRESS --> COMPLETED: Driver completes
    ASSIGNED --> CANCELLED: Admin/User cancels
...
| ----------- | --------------------------------- |
| ASSIGNED    | Start Pickup, Navigate, Call User |
| IN_PROGRESS | Complete, Navigate, Call User     |
