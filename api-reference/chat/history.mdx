---
title: "Chat History"
description: "Retrieve conversation history for a specific booking or support thread"
...
curl "https://api.trash2treasure.lk/api/chat/history" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

# Get last 10 messages
curl "https://api.trash2treasure.lk/api/chat/history?limit=10" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
