...
```bash
# Get all users
curl "https://api.trash2cash.lk/api/admin/users" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

# Filter by role
curl "https://api.trash2cash.lk/api/admin/users?role=DRIVER" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

# Search users
curl "https://api.trash2cash.lk/api/admin/users?search=john" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
