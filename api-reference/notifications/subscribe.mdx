...
description: "Subscribe to push notifications for booking updates and platform events"
...
```bash
curl -X POST "https://api.trash2treasure.lk/api/notifications/subscribe" \
