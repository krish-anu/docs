---
title: "List Bookings"
description: "List all waste pickup bookings with filtering and pagination options"
...
```bash
# Get all bookings
curl "https://api.trash2treasure.lk/api/bookings" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

# Filter by status
curl "https://api.trash2treasure.lk/api/bookings?status=PENDING" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

# Paginate
curl "https://api.trash2treasure.lk/api/bookings?page=2&limit=5" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
