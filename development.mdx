---
title: "Development"
description: "Set up your local development environment for Trash2Treasure waste marketplace"
---
...
```bash
# Database
DATABASE_URL="postgresql://user:password@localhost:5432/trash2treasure"
DIRECT_URL="postgresql://user:password@localhost:5432/trash2treasure"
